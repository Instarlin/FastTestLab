...
export default function Home() {
  return (
    <div className="flex flex-col md:flex-row h-screen">
      ...
      <div className="relative flex flex-col flex-shrink-0 min-w-0 w-[calc(100%-52px)] shadow-[-4px_0px_6px_-1px_rgba(0,0,0,0.15)] rounded-tl-4xl px-0 py-0 text-gray-950 bg-white">
